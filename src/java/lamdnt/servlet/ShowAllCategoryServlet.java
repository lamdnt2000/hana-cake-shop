 ...
 * @author sasuk
 */
@WebServlet(name = "ShowAllCategoryServlet", urlPatterns = {"/api/ShowAllCategoryServlet"})
public class ShowAllCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ShowAllCategoryServlet_NamingException:" + ex.getMessage());
        } catch (SQLException ex) {
            log("ShowAllCategoryServlet_SQLException:" + ex.getMessage());
        } finally {
               out.close();
        }
    }
