 ...
 * @author sasuk
 */
@WebServlet(name = "GetTotalProductSearch", urlPatterns = {"/api/GetTotalProductSearch"})
public class GetTotalProductSearch extends HttpServlet {
